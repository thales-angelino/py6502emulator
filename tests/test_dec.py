...
from emulator_6502.instructions import dec
...
class TestDEC(unittest.TestCase):
    ...
    def test_dec_absolute(self):
        ...
        address = 0x02ff
        expected_value = 0x7f
        self.memory.memory[emulator.START_ADDRESS] = dec.DEC_ABSOLUTE_OPCODE
    ...
    def test_dec_absolutex(self):
        ...
        expected_value = 0xff
        address = 0x0300
        self.memory.memory[emulator.START_ADDRESS] = dec.DEC_ABSOLUTEX_OPCODE
        self.memory.memory[emulator.START_ADDRESS + 1] = 0xff # LSB FIRST!!!
        self.memory.memory[emulator.START_ADDRESS + 2] = 0x02
        self.memory.memory[address] = value
        self.cpu.x = 0x01
    ...
    def test_dec_zeropage(self):
        ...
        expected_value = 0xff
        address = 0x00ff
        self.memory.memory[emulator.START_ADDRESS] = dec.DEC_ZEROPAGE_OPCODE
    ...
    def test_dec_zeropagex(self):
        ...
        expected_value = 0xff
        address = 0x008f
        self.memory.memory[emulator.START_ADDRESS] = dec.DEC_ZEROPAGEX_OPCODE
