...
from emulator_6502.instructions import bcs
...
class TestBCS(unittest.TestCase):
    ...
    def test_bcs_scenario1(self):
        expected_cycles = 3
        value = 0x03
        expected_pc = 0x604
        self.memory.memory[emulator.START_ADDRESS] = bcs.BCS_RELATIVE_OPCODE
