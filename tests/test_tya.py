...
from emulator_6502.instructions import tya
...
class TestTYA(unittest.TestCase):
    ...
    def test_tya(self):
        expected_cycles = 2
        self.cpu.y = 0xaf
        self.memory.memory[emulator.START_ADDRESS] = tya.TYA_IMPLIED_OPCODE
        self.cpu.execute(1)
        self.assertEqual(self.cpu.a, self.cpu.y, "Register A should contain: %s" % hex(self.cpu.a))
